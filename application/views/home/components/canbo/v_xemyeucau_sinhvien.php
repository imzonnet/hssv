...
?><form action="<?php echo base_url('canbo/xemyeucausinhvien').'/'.$nd[0]['MaSo']; ?>" method="post" accept-charset="uft-8">
	...
	<a class="btn btn-info" href="<?php echo base_url('canbo/yeucausinhvien');?>">Trở lại danh sách</a>
</form>

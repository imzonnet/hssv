<div class="alert">
    ...
    <br /><b>Tìm kiếm theo địa chỉ ngoại tru</b>
</div>
<form id="frmSearchSV" name="frmSearchSV" method="post" class="form-horizontal" action="<?php echo base_url('canbo/tksvnt'); ?>/">
    ...
    <div class="control-group">
        <div class="controls">
            <input type="submit" name="searchsv" value="Tìm kiếm" class="btn btn-primary" />
        </div>
    </div>
</form>
<form id="frmSearchLop" name="frmSearchLop" method="post" class="form-horizontal" action="<?php echo base_url('canbo/tklopnt'); ?>/">
    <div class="control-group">
        <label class="control-label">
            Lớp sinh hoạt
        </label>
...
<form id="frmSearchAdd" name="frmSearchAdd" method="post" class="form-horizontal" action="<?php echo base_url('canbo/tkdcnt'); ?>/">
    <div class="control-group">
        <label class="control-label">
            Địa chỉ:
        </label>
        <div class="controls">
            <p><select name="quan" id="quan"><?php echo $ds_quan; ?></select></p>
    ...
    <div class="control-group">
        <div class="controls">
            <input type="submit" name="searchdc" value="Tìm kiếm" class="btn btn-primary" />
        </div>
    </div>
</form>

...
<p>
    ...
    <a href="<?php echo base_url('canbo').'/thongkedcnt/'.$mquan.'/'.$mphuong;?>" onclick="mocuaso('<?php echo base_url('canbo').'/thongkedcnt/'.$mquan.'/'.$mphuong;?>',1000,700);return false;" class="btn btn-success"><i class="icon-print icon-white"></i> In Thống Kê</a>
</p>
